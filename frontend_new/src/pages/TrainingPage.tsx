...
const TrainingPage: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-slate-50 overflow-hidden">
            ...
            {/* Docked Rack + Controls — sitting at the bottom of the flex layout (no longer fixed/overlay) */}
            <div className="shrink-0 w-full p-3 sm:p-4 pb-20 sm:pb-4 flex justify-center">
                <div className="w-full max-w-xl bg-slate-900/85 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/20
                                p-3 sm:p-4 flex flex-col gap-3 z-40
